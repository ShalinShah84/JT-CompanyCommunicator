        ...
        public async Task<string> MoveDraftToSentPartitionAsync(NotificationDataEntity draftNotificationEntity)
        {
            try
            {
                ...
                var sentNotificationEntity = new NotificationDataEntity
                {
                    ...
                    IsAcknowledged = draftNotificationEntity.IsAcknowledged,
                    IsUrgent = draftNotificationEntity.IsUrgent,
                    IsNormal = draftNotificationEntity.IsNormal,
                    ...
                    Color = draftNotificationEntity.Color,
            ...
            string createdBy)
        {
            try
            {
                ...
                var newNotificationEntity = new NotificationDataEntity
                {
                    ...
                    Summary = Regex.Replace(notificationEntity.Summary, @"<[^>]*>", string.Empty),
                    Author = notificationEntity.Author,
                    ButtonTitle = notificationEntity.ButtonTitle,
                    ButtonLink = notificationEntity.ButtonLink,
                    Buttons = notificationEntity.Buttons,
                    IsImportant = notificationEntity.IsImportant,
                    IsAcknowledged = notificationEntity.IsAcknowledged,
                    IsUrgent = notificationEntity.IsUrgent,
                    IsNormal = notificationEntity.IsNormal,
                    CreatedBy = createdBy,
                    CreatedDate = DateTime.UtcNow,
                    IsDraft = true,
                    Teams = notificationEntity.Teams,
                    Groups = notificationEntity.Groups,
                    Color = notificationEntity.Color,
