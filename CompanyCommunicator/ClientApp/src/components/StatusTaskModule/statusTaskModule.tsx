...
class StatusTaskModule extends React.Component<StatusTaskModuleProps, IStatusState> {
        ...
        if ('id' in params) {
            ...
            this.getItem(id).then(() => {
                this.setState({
                    ...
                    console.log("componentDidMount" + this.state.message.summary);
                                ...
                                <Flex.Item size="size.half" className="formContentContainer">
                                    <Flex column>
                                        ...
                                        <div className="contentField">
                                            <div className="contentField">
                                                <h3>{
                                                    this.state.message.buttonTrackingClicks ? this.localize("Acknowledgement Results") : ""
                                                }</h3>
    ...
    private renderButtonClicks = () => {
        ...
        if (this.state.message.buttonTrackingClicks) {
            ...
            console.log("Inside button click" + btnClicks.Name);
            return (
                <div>
